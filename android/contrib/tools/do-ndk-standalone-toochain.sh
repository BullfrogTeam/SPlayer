...
echo "param FF_ARCH = $FF_ARCH"

echo ""

echo "param FF_BUILD_ROOT = $FF_BUILD_ROOT"
...
echo "param FF_MAKE_TOOLCHAIN_FLAGS = $FF_MAKE_TOOLCHAIN_FLAGS"
echo "param FF_TOOLCHAIN_TOUCH = $FF_TOOLCHAIN_TOUCH"
echo "param FF_ANDROID_PLATFORM = $FF_ANDROID_PLATFORM"
